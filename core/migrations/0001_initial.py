# Generated by Django 3.0.2 on 2020-12-27 08:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=10, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+0000000000'", regex='^\\+?1?\\d{9,10}$')])),
